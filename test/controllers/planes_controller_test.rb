...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { model: @plane.model, name: @plane.name, type: @plane.type } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { model: @plane.model, name: @plane.name, type: @plane.type } }
